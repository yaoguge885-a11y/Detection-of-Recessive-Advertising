...
# 也加入当前目录，以便 import crawler_utils 等同目录模块
_crawler_here = str(Path(__file__).resolve().parent)
if _crawler_here not in sys.path:
    sys.path.insert(0, _crawler_here)
...
from crawler_utils import build_post_record  # noqa: E402 (import after path setup)
