...
2026-07-31实测：`27 passed, 1 warning in 4.01s`。再运行`python -m pytest -q`，本轮全量为`389 passed, 2 skipped, 1 warning in 12.65s`；warning是既有Starlette/httpx TestClient弃用提示。
...
- 先确保第3节`389 passed, 2 skipped, 1 warning`的本地基线已经保存。
