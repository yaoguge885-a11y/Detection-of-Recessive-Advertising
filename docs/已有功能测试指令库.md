...
> 当前实测基线：2026-07-31，分支 `P2_Tool-Compartment-Model-Tooling`
...
2026-07-31 P5.2工程门后的实测快照：

```text
390 passed, 2 skipped, 1 warning
```

正确理解：

- `390 passed`：当前收集到的默认测试全部通过；
...
### 4.11 分置信度自动判断标注系统（co-pilot-auto-judge）
...
### 4.12 P1→P3 Schema v1.2 与本地 M1 数据复核
...
- 先确保第3节`390 passed, 2 skipped, 1 warning`的本地基线已经保存。
